...
@section('content')
    ...
    <div class="all">
        <div class="navall">
            <div class="subhover">
                <h1 class="title">{{__("Dr. Abdulkadir Narin")}}</h1>
                ...
                <span style="font-size: 16px">{{__("Dr. Abdulkadir Narin")}}</span>
            </div>
        </div>

        <div class="wraparrall">
            <swiper-container style="margin-top: 30px" class="mySwiper" navigation="true" pagination="true" keyboard="true" mousewheel="true"
                              css-mode="true">
...
@endpush
@push('script')
    <link rel="stylesheet" href="{{asset('assets/front/js/about.css')}}">
@endpush
